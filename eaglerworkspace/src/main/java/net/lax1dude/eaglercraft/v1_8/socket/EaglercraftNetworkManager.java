...
import proclient.event.events.EventReceivePacket;
...
public class EaglercraftNetworkManager {
	...
	public void sendPacket(Packet pkt) {
		EventReceivePacket eventReceivePacket = new EventReceivePacket(pkt);
        Dragon.moduleManager.onEvent(eventReceivePacket);
